...
final class Config
{
    ...
    public function dynamicDir(string $dir = __DIR__, int $level = 3): string
    {
    ...
    {
        return __('Menu Example', 'wp-plugin-template');
    }
    ...
    public function wordpressNamespace(): string
    {
        return 'WPlugin\\WordPress';
    }
